...
public class KNDB4000Entity {
    ...
    // 构造函数
    public KNDB4000Entity() {}
    
    public KNDB4000Entity(Integer weekNumber, String startWeekDate, String endWeekDate, Integer fixedStatus) {
